                        ...
                        <Row>
                            <Col md="4">
                                <div className="footer-logo-info">
                                    <img src={process.env.PUBLIC_URL + "/assets/images/f-logo.jpeg"} alt="" className="img-fluid" width="342" height="82"/>
                                    ...
                                    <ul className="list-unstyled">
                                        <li><i className="las la-map-marker"></i>Gangolli, udupi dist, karnataka.</li>
                                        <li><i className="las la-envelope"></i>info@touheed.education</li>
                                        <li><i className="las la-phone"></i>+91 999 999 9999</li>
                                    </ul>
                                </div>
                            </Col>
                            <Col md="4">
                                ...
                                <div className="f-post">
                                    ...
                                    <div className="post-box d-flex">
                                        ...
                                        <div className="post-content">
                                            <Link to={process.env.PUBLIC_URL +"/blog-details"}>72 nd Independence Day Celebrations...</Link>
                                    ...
                                    <div className="post-box d-flex">
                                        ...
                                        <div className="post-content">
                                            <Link to={process.env.PUBLIC_URL +"/blog-details"}>A session on Career Guidance....</Link>
                                            <span>Aug 15, 2018</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Row>
                            <Col md="6">
                                <div className="copy-text">
                                    <p>Copyright &copy; 2020 | Designed With <i className="las la-heart"></i> by <a href={process.env.PUBLIC_URL + "/"} target="_blank" rel="noopener noreferrer">Abdul Waheed</a></p>
                                </div>
                            </Col>
